...
class Simulation():
    ...
    def image_simulate(self, save_image_name):
            ...
            for j in range(self.col):
                if j == 0 or j == self.col - 1 or i == 0 or i == self.row - 1:
                    ...
                    for b in range(self.band):
                        ...
                        one_y_train = np.array(one_y_train, dtype=np.float64)
                        ...
                        try:
                            ...
                            one_r2 = model_one.rsquared
                            three_r2 = model_three.rsquared
                            one_r2_array[i, j, b] = model_one.rsquared
                            three_r2_array[i, j, b] = model_three.rsquared
        ...
        np.save('spring_one_r2.npy', one_r2_array)
        np.save('spring_three_r2.npy', three_r2_array)
if __name__ == "__main__":
    ...
    if not os.path.exists(save_path):
        os.mkdir(save_path)
    save_image_name = save_path + "/20210323_rsquared_dtype64.tif"
